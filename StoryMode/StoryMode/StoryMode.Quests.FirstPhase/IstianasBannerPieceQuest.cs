...
public class IstianasBannerPieceQuest : StoryModeQuestBase
{
	...
	private TextObject _startQuestLog => new TextObject("{=GxlPj4GC}Find the hideout that Istiana told you about and get the next banner piece.", (Dictionary<string, object>)null);

	public override TextObject Title => new TextObject("{=WTjAYUoD}Find Another Piece of the Banner for Istiana", (Dictionary<string, object>)null);
