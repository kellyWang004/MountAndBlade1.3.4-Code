...
public class TradeAgreementDecisionItemVM : DecisionItemBaseVM
{
	...
	public IFaction TargetFaction => (_decision as TradeAgreementDecision).TargetKingdom;
	...
	public string TradeAgreementDescriptionText
	{
		get
		{
			return _tradeAgreementDescriptionText;
		}
		set
		{
			if (value != _tradeAgreementDescriptionText)
			{
				_tradeAgreementDescriptionText = value;
				OnPropertyChangedWithValue(value, "TradeAgreementDescriptionText");
			}
		}
	}
	...
	{
		_tradeAgreementDecision = decision;
	...
	{
		base.InitValues();
		TextObject textObject = GameTexts.FindText("str_kingdom_decision_trade_agreement");
		NameText = textObject.ToString();
		TextObject textObject2 = GameTexts.FindText("str_kingdom_decision_trade_agreement_desc");
		textObject2.SetTextVariable("FACTION", TargetFaction.Name);
		TradeAgreementDescriptionText = textObject2.ToString();
