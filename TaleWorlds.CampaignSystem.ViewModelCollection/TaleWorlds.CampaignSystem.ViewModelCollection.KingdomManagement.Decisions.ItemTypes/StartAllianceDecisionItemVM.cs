...
public class StartAllianceDecisionItemVM : DecisionItemBaseVM
{
	...
	public IFaction TargetFaction => (_decision as StartAllianceDecision).KingdomToStartAllianceWith;
	...
	public string StartAllianceDescriptionText
	{
		get
		{
			return _startAllianceDescriptionText;
		}
		set
		{
			if (value != _startAllianceDescriptionText)
			{
				_startAllianceDescriptionText = value;
				OnPropertyChangedWithValue(value, "StartAllianceDescriptionText");
			}
		}
	}
	...
	{
		_startAllianceDecision = decision;
		base.DecisionType = 7;
	}
	...
	{
		base.InitValues();
		TextObject textObject = GameTexts.FindText("str_kingdom_decision_start_alliance");
		NameText = textObject.ToString();
		TextObject textObject2 = GameTexts.FindText("str_kingdom_decision_start_alliance_desc");
		textObject2.SetTextVariable("FACTION", TargetFaction.Name);
		StartAllianceDescriptionText = textObject2.ToString();
