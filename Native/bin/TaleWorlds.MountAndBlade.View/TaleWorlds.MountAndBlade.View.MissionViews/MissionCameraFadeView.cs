...
public class MissionCameraFadeView : MissionView
{
	...
	public override void OnMissionScreenTick(float dt)
	{
		...
		if (((MissionBehavior)this).Mission != null && base.MissionScreen.IsMissionTickable && !MBCommon.IsPaused)
		{
			UpdateFadeState(dt);
		}
	}
	...
	{
		if (((MissionBehavior)this).Mission != null && base.MissionScreen.IsMissionTickable && FadeState == CameraFadeState.White)
		{
			_autoFadeIn = true;
	...
	{
		if (((MissionBehavior)this).Mission != null && base.MissionScreen.IsMissionTickable && FadeState == CameraFadeState.Black && !_autoFadeIn)
		{
			_fadeOutTime = 0f;
			_blackTime = 0f;
			_fadeInTime = MathF.Max(fadeInTime, 1E-05f);
